...
class AccTableCity(AccTable):
    def __init__(self) -> None:
        ...
        self.columns.append(SqlColumn("chips", "INTEGER", create_if_missing=True, default=69))

        self.columns.append(SqlColumn("food", "INTEGER", create_if_missing=True, default=69, is_int64=True))
