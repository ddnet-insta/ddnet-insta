...
void CPlayer::Snap(int SnappingClient)
{
	...
	// ddnet-insta
	GameServer()->m_pController->SnapDDNetPlayer(SnappingClient, this, &DDNetPlayer);
...
void CPlayer::SendConnect(int FakeId, int ClientId)
{
	...
	GameServer()->m_pController->SendClientInfo7(&NewClientInfoMsg, ClientId, m_ClientId, MSGFLAG_VITAL | MSGFLAG_NORECORD | MSGFLAG_NOTRANSLATE);
}
