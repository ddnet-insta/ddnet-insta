...
MACRO_CONFIG_INT(SvDisplayScore, sv_display_score, 0, 0, (int)EDisplayScore::NUM_SCORES, CFGFLAG_SERVER, "0=round_points 1=points 2=spree 3=current_spree 4=wins 5=kills 6=round_kills")
