...
static constexpr size_t MAX_SALT_LENGTH = 16;
static constexpr size_t MAX_HASH_WITH_SALT_LENGTH = MAX_SALT_LENGTH + 4 + SHA256_MAXSTRSIZE;
...
/// INTERNAL METHODS!
///
/// The underscore prefixed methods
/// are internal helpers and not
/// really a generic public api
/// they could be static too
/// but they are in the header
/// so they can be tested in
/// the unit tests
///
///////////////////////////////////

// Return a random number in the inclusive range from Min to Max
// so the lowest possible value is Min and the highest possible
// return value is Max
