...
// This used to be ddnet code but got removed upstream. Since we kept it moved to ddnet-insta code
//
// "/credits_ddnet"
void CGameContext::ConDDNetCredits(IConsole::IResult *pResult, void *pUserData)
{
...
void CGameContext::ConLogin(IConsole::IResult *pResult, void *pUserData)
{
	...
	char aBuf[512];
	if(!IsValidUsernameAndPasswordRelaxed(pUsername, pPassword, aBuf, sizeof(aBuf)))
	{
		pSelf->SendChatTarget(pResult->m_ClientId, aBuf);
		return;
	}
...
void CGameContext::ConLogoutAccount(IConsole::IResult *pResult, void *pUserData)
{
	...
	pSelf->m_pController->LogoutAccount(pPlayer, "Successfully logged out of your account", false);
}
...
void CGameContext::ConChangePassword(IConsole::IResult *pResult, void *pUserData)
{
	...
	if(!IsValidUsernameAndPasswordRelaxed(pPlayer->m_Account.m_aUsername, pOldPassword, aBuf, sizeof(aBuf)))
	{
		pSelf->SendChatTarget(pResult->m_ClientId, aBuf);
		return;
	}
