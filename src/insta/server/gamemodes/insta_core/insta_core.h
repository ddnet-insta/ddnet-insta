...
public:
	...
	bool SendClientInfo7(const protocol7::CNetMsg_Sv_ClientInfo *pClientInfo, int InfoOwnerClientId, int ClientId, int Flags) override;
	bool SendClientDrop7(const protocol7::CNetMsg_Sv_ClientDrop *pMsg, int InfoOwnerClientId, int ClientId, int Flags) override;
